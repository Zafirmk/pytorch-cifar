...
wandb.init(project = "CIFAR10", mode="offline")
...
trainset = torchvision.datasets.CIFAR10(root='/home/zafirmk/scratch/cifar', 
                   train=True, 
                   download=False,
...
testset = torchvision.datasets.CIFAR10(root='/home/zafirmk/scratch/cifar', 
                   train=False, 
                   download=False,
